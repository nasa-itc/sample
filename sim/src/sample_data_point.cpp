...
namespace Nos3
{
    ...
    SampleDataPoint::SampleDataPoint(double count) : _not_parsed(false)
    {
    ...
    SampleDataPoint::SampleDataPoint(int16_t spacecraft, const boost::shared_ptr<Sim42DataPoint> dp) : _dp(*dp), _sc(spacecraft), _not_parsed(true)
    {
